...
exports.updateResultRelation = exports.getRelationResult = exports.stripIdSymbolsFromResult = exports.addIdSymbolsToResult = void 0;
...
function addIdSymbolsToResult(result, parentId, startId = 1) {
    let id = startId;
...
exports.addIdSymbolsToResult = addIdSymbolsToResult;
function stripIdSymbolsFromResult(result) {
    if (Array.isArray(result)) {
        result.forEach((item) => {
            if (typeof item === "object" && item !== null) {
...
exports.stripIdSymbolsFromResult = stripIdSymbolsFromResult;
function getRelationResult(result, relations) {
...
exports.getRelationResult = getRelationResult;
...
function updateResultRelation(result, relation, relationResult) {
    if (Array.isArray(result)) {
        result.forEach((item) => {
...
exports.updateResultRelation = updateResultRelation;
