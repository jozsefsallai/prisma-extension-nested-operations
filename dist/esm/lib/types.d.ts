...
export type NestedWriteOperation = "create" | "update" | "upsert" | "connectOrCreate" | "connect" | "disconnect" | "createMany" | "updateMany" | "delete" | "deleteMany";
...
export type ExecuteFunction<ExtArgs extends Types.Extensions.InternalArgs = Types.Extensions.DefaultArgs, T = any> = (params: NestedParams<ExtArgs>) => Promise<T>;
